...
public class MultipleIterateTest {
	...
	public static void main(String[] args) throws IOException, SQLException {
		...
		List<emp> empList = sqlMap.queryForList("multiple_iterate", map);
		...
		for (int i = 0; i < size; i++) {
			...
			System.out.println("id : " + emp.getEmpno() + ", name : " + emp.getEname() + ", job : " + emp.getJob()
					+ ", sal : " + emp.getSal());
